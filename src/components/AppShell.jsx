export default function AppShell({ currentPage, onNavigate, hideNav, children }) {
  const navItems = [
  ...
  return (
    <div className="flex flex-col min-h-svh" style={{ background: '#0a0a0f' }}>
      <header
        className="sticky top-0 z-30 flex items-center justify-between px-5 py-4 border-b"
        ...
        >
          {navItems.map(item => (
            <button
              ...
              style={{ color: currentPage === item.id ? '#a78bfa' : '#4b5563' }}
            >
